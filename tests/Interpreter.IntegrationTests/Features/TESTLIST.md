...
|-----------|---------------------|
| Объявление int | `0` |
| Объявление str | `Hello World` |
| Объявление float | `3.14` |
| Присваивание нового значения | `0.0` |

### Тесты на неверное присвоение/объявление

| Тест-кейс | Ожидаемый результат |
|-----------|---------------------|
| Присвоение необъявленной переменной | `UnknownSymbolException` |
| Дублирование переменной | `DuplicateSymbolException` |
| Присвоение int в float при инициализации | `TypeErrorException` |
| Присвоение str в float после инициализации | `TypeErrorException` |
| Присвоение str в int при инициализации | `TypeErrorException` |
| Присвоение str в int после инициализации | `TypeErrorException` |
| Присвоение int в str при инициализации | `TypeErrorException` |
| Присвоение int в str после инициализации | `TypeErrorException` |
| Присвоение float в int при инициализации | `TypeErrorException` |
| Присвоение float в int после инициализации | `TypeErrorException` |

### Тесты выражений с переменными (Expressions With Variables)

| Тест-кейс | Входные данные | Ожидаемый результат |
|-----------|----------------|---------------------|
| Оператор modulo с возведением в степень | `["4"]` | `4` |
| Возведение в степень с изменением переменной | `["2", "2"]` | `16` |
| Возведение отрицательного числа в степень | `["-5", "2"]` | `25` |
| Отрицательное число перед степенью | `["-5", "2"]` | `-25` |
| Степень отрицательного числа в скобках | `["-5", "2"]` | `25` |
| Сложное арифметическое выражение | `["1", "2"]` | `12` |
| Конкатенация строк | `["Hello, ", "World!"]` | `Hello, World!` |
| Вычисление площади круга | `["3"]` | `28.2743` |